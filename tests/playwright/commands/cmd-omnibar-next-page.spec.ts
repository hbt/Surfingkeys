...
const SUITE_LABEL = 'cmd_omnibar_next_page';
...
const UNIQUE_ID = 'cmd_omnibar_next_page';
const KEY = '<Ctrl-.>';

test.describe('cmd_omnibar_next_page (Playwright)', () => {
    ...
    test('cmd_omnibar_next_page is invocable with omnibar open', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Load next page of omnibar results
            ...
            const ok = await invokeCommand(page, 'cmd_omnibar_next_page');
