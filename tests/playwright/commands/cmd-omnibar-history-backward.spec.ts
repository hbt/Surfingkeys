...
const SUITE_LABEL = 'cmd_omnibar_history_backward';
...
const UNIQUE_ID = 'cmd_omnibar_history_backward';
const KEY = '<Ctrl-p>';

test.describe('cmd_omnibar_history_backward (Playwright)', () => {
    ...
    test('cmd_omnibar_history_backward is invocable with omnibar open', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Navigate backward in omnibar input history
            ...
            const ok = await invokeCommand(page, 'cmd_omnibar_history_backward');
