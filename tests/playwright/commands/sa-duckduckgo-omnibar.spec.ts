...
const KEY = 'od';
const UNIQUE_ID = 'sa_duckduckgo_omnibar';

const SUITE_LABEL = 'sa_duckduckgo_omnibar';
...
test.describe('sa_duckduckgo_omnibar (od — duckduckgo search omnibar)', () => {
    ...
    test('pressing od opens duckduckgo search omnibar', async () => {
        await withPersistedDualCoverage(
            { suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl },
            test.info().title,
            async () => {
                // 'od' is registered via addSearchAlias('d', 'duckduckgo', ...)
                ...
                if (DEBUG) console.log('Omnibar open state after od:', opened);
