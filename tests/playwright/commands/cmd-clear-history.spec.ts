...
const SUITE_LABEL = 'cmd_clear_history';
...
test.describe('cmd_clear_history (Playwright)', () => {
    ...
    test.beforeEach(async () => {
        ...
        await callSKApi(page, 'mapcmdkey', 'zH', 'cmd_clear_history');
    });
    ...
    test('cmd_clear_history executes via command bar without error', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Clears input history for 'find' context
            ...
            await page.keyboard.type('clearHistory find');
