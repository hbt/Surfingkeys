...
const KEY = 'sG';
const UNIQUE_ID = 'sa_google_visual_tab';

const SUITE_LABEL = 'sa_google_visual_tab';
...
test.describe('sa_google_visual_tab (sG — Search selected with Google interactive)', () => {
    ...
    test('sG opens google search omnibar in interactive mode', async () => {
        ...
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                if (DEBUG) console.log('Omnibar open state after sG:', opened);
