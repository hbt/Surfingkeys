...
const SUITE_LABEL = 'cmd_list_queue_urls';
...
test.describe('cmd_list_queue_urls (Playwright)', () => {
    ...
    test.beforeEach(async () => {
        ...
        await callSKApi(page, 'mapcmdkey', 'listQueueURLs', 'cmd_list_queue_urls');
    });

    test('cmd_list_queue_urls executes via command bar without error', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Lists all URLs in the queue (empty in test env)
            ...
            await page.keyboard.type('listQueueURLs');
