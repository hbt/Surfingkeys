...
const KEY = 'sH';
const UNIQUE_ID = 'sa_github_visual_tab';

const SUITE_LABEL = 'sa_github_visual_tab';
...
test.describe('sa_github_visual_tab (sH — Search selected with GitHub interactive)', () => {
    ...
    test('sH opens github search omnibar in interactive mode', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                if (DEBUG) console.log('Omnibar open state after sH:', opened);
