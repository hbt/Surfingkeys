...
const SUITE_LABEL = 'cmd_tab_detach_magic_right_inclusive_key';
...
test.describe('cmd_tab_detach_magic_right_inclusive_key (Playwright)', () => {
    ...
    test('cmd_tab_detach_magic_right_inclusive detaches current + right tabs via tdE', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                await callSKApi(anchor, 'mapcmdkey', 'tdE', 'cmd_tab_detach_magic_right_inclusive');
