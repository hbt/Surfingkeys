...
const SUITE_LABEL = 'cmd_tab_detach_current';
...
test.describe('cmd_tab_detach (Playwright)', () => {
    ...
    test.beforeEach(async () => {
        ...
        await callSKApi(page, 'mapcmdkey', 'tdt', 'cmd_tab_detach');
    });
    ...
    test('cmd_tab_detach_current detaches the active tab into a new window', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                if (DEBUG) console.log(`cmd_tab_detach_current: windows ${beforeCount} → ${afterWindows.length}`);
