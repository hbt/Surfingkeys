...
const SUITE_LABEL = 'cmd_omnibar_create_mark';
...
const UNIQUE_ID = 'cmd_omnibar_create_mark';
const KEY = '<Ctrl-m>';

test.describe('cmd_omnibar_create_mark (Playwright)', () => {
    ...
    test('cmd_omnibar_create_mark is invocable with omnibar open', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Create a mark for the focused omnibar item
            ...
            const ok = await invokeCommand(page, 'cmd_omnibar_create_mark');
