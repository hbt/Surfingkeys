...
const SUITE_LABEL = 'cmd_tab_detach_magic_left_key';
...
test.describe('cmd_tab_detach_magic_left_key (Playwright)', () => {
    ...
    test('cmd_tab_detach_magic_left detaches tabs to the left into a new window via tdq', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                await callSKApi(anchor, 'mapcmdkey', 'tdq', 'cmd_tab_detach_magic_left');
                ...
                if (DEBUG) console.log(`cmd_tab_detach_magic_left_key: windows ${beforeCount} → ${afterWindows.length}`);
