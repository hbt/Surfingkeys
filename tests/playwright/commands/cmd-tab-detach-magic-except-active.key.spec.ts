...
const SUITE_LABEL = 'cmd_tab_detach_magic_except_active_key';
...
test.describe('cmd_tab_detach_magic_except_active_key (Playwright)', () => {
    ...
    test('cmd_tab_detach_magic_except_active detaches all tabs except active into a new window via tdc', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                await callSKApi(anchor, 'mapcmdkey', 'tdc', 'cmd_tab_detach_magic_except_active');
                ...
                if (DEBUG) console.log(`cmd_tab_detach_magic_except_active_key: windows ${beforeCount} → ${afterWindows.length}`);
