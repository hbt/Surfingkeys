...
test.describe('cmd_tools_edit_url_reload (Playwright)', () => {
    ...
    test.beforeEach(async () => {
        ...
        await callSKApi(page, 'mapcmdkey', ';U', 'cmd_tools_edit_url_reload');
    });
    ...
    test('cmd_tools_edit_url_reload opens editor with current URL', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            const ok = await invokeCommand(page, 'cmd_tools_edit_url_reload');
