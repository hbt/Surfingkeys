...
const SUITE_LABEL = 'cmd_omnibar_delete_focused';
...
const UNIQUE_ID = 'cmd_omnibar_delete_focused';
const KEY = '<Ctrl-d>';

test.describe('cmd_omnibar_delete_focused (Playwright)', () => {
    ...
    test('cmd_omnibar_delete_focused is invocable with omnibar open', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Delete the focused item from omnibar results
            ...
            const ok = await invokeCommand(page, 'cmd_omnibar_delete_focused');
