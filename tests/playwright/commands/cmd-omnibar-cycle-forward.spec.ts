...
const SUITE_LABEL = 'cmd_omnibar_cycle_forward';
...
const UNIQUE_ID = 'cmd_omnibar_cycle_forward';
const KEY = '<Tab>';

test.describe('cmd_omnibar_cycle_forward (Playwright)', () => {
    ...
    test('cmd_omnibar_cycle_forward is invocable with omnibar open', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Cycle forward through omnibar result types
            ...
            const ok = await invokeCommand(page, 'cmd_omnibar_cycle_forward');
