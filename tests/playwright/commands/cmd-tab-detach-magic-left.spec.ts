...
const SUITE_LABEL = 'cmd_tab_detach_magic_left';
...
test.describe('cmd_tab_detach_magic_left (Playwright)', () => {
    ...
    test('cmd_tab_detach_magic_left with repeat=2 detaches 2 tabs to the left into a new window', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                // Layout: [l0, l1, l2, anchor, r]
                // Reopen anchor after creating the left-side tabs so it sits to their right.
                await anchor.close();
                ...
                await callSKApi(anchor2, 'mapcmdkey', 'g-003', 'cmd_tab_detach_magic_left');
                ...
                await invokeCommand(anchor2, 'cmd_tab_detach_magic_left', 2);
                ...
                if (DEBUG) console.log(`cmd_tab_detach_magic_left: windows ${beforeCount} → ${afterWindows.length}`);
