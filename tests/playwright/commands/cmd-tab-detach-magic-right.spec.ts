...
const SUITE_LABEL = 'cmd_tab_detach_magic_right';
...
test.describe('cmd_tab_detach_magic_right (Playwright)', () => {
    ...
    test('cmd_tab_detach_magic_right with repeat=2 detaches 2 tabs to the right into a new window', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                await callSKApi(anchor, 'mapcmdkey', 'g-002', 'cmd_tab_detach_magic_right');
                ...
                await invokeCommand(anchor, 'cmd_tab_detach_magic_right', 2);
                ...
                if (DEBUG) console.log(`cmd_tab_detach_magic_right: windows ${beforeCount} → ${afterWindows.length}`);
