...
const SUITE_LABEL = 'cmd_tab_copy_urls_magic_all_windows';
...
test.describe('cmd_tab_copy_urls_magic_all_windows (Playwright)', () => {
    ...
    test('cmd_tab_copy_urls_magic_all_windows copies all tabs except the active tab across all windows', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                await callSKApi(anchor, 'mapcmdkey', 'g-015', 'cmd_tab_copy_urls_magic_all_windows');
