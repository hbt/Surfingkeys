...
const SUITE_LABEL = 'cmd_chrome_net_internals';
const FIXTURE_URL = `${FIXTURE_BASE}/scroll-test.html`;
const CONTENT_COVERAGE_URL = `${FIXTURE_URL}#cov_cmd_chrome_net_internals`;
const EXPECTED_URL_PREFIX = 'chrome://net-internals';

let context: BrowserContext;
let covBg: ServiceWorkerCoverage | undefined;
let initContentCoverageForUrl: ((url: string) => Promise<ServiceWorkerCoverage | undefined>) | undefined;

test.describe('cmd_chrome_net_internals (Playwright)', () => {
    ...
    test('opens chrome://net-internals/#proxy tab', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                const invoked = await invokeCommand(page, 'cmd_chrome_net_internals');
                expect(invoked, 'invokeCommand must acknowledge cmd_chrome_net_internals').toBe(true);
