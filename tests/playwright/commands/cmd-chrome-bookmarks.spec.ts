...
const SUITE_LABEL = 'cmd_chrome_bookmarks';
const FIXTURE_URL = `${FIXTURE_BASE}/scroll-test.html`;
const CONTENT_COVERAGE_URL = `${FIXTURE_URL}#cov_cmd_chrome_bookmarks`;
const EXPECTED_URL_PREFIX = 'chrome://bookmarks';

let context: BrowserContext;
let covBg: ServiceWorkerCoverage | undefined;
let initContentCoverageForUrl: ((url: string) => Promise<ServiceWorkerCoverage | undefined>) | undefined;

test.describe('cmd_chrome_bookmarks (Playwright)', () => {
    ...
    test('opens chrome://bookmarks/ tab', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                const invoked = await invokeCommand(page, 'cmd_chrome_bookmarks');
                expect(invoked, 'invokeCommand must acknowledge cmd_chrome_bookmarks').toBe(true);
