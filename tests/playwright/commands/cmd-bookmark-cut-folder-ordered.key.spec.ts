...
const SUITE_LABEL = 'cmd_bookmark_cut_folder_ordered';
const FIXTURE_URL = `${FIXTURE_BASE}/scroll-test.html`;
const KEY = 'b';
const UNIQUE_ID = 'cmd_bookmark_cut_folder_ordered';
...
test.describe('cmd_bookmark_cut_folder_ordered (pending-key, Playwright)', () => {
