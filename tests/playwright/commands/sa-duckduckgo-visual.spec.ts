...
const KEY = 'sd';
const UNIQUE_ID = 'sa_duckduckgo_visual';

const SUITE_LABEL = 'sa_duckduckgo_visual';
...
test.describe('sa_duckduckgo_visual (sd — Search selected text with DuckDuckGo)', () => {
    ...
    test('sd opens a new tab with duckduckgo search URL', async () => {
