...
const SUITE_LABEL = 'cmd_bookmark_cut_folder_reversed';
const FIXTURE_URL = `${FIXTURE_BASE}/scroll-test.html`;
const KEY = 'b';
const UNIQUE_ID = 'cmd_bookmark_cut_folder_reversed';
...
test.describe('cmd_bookmark_cut_folder_reversed (pending-key, Playwright)', () => {
