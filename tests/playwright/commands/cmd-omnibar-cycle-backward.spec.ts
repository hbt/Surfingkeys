...
const SUITE_LABEL = 'cmd_omnibar_cycle_backward';
...
const UNIQUE_ID = 'cmd_omnibar_cycle_backward';
const KEY = '<Shift-Tab>';

test.describe('cmd_omnibar_cycle_backward (Playwright)', () => {
    ...
    test('cmd_omnibar_cycle_backward is invocable with omnibar open', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Cycle backward through omnibar result types
            ...
            const ok = await invokeCommand(page, 'cmd_omnibar_cycle_backward');
