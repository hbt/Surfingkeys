...
const SUITE_LABEL = 'cmd_tab_copy_urls_magic_all_window';
...
test.describe('cmd_tab_copy_urls_magic_all_window (Playwright)', () => {
    ...
    test('cmd_tab_copy_urls_magic_all_window copies all URLs in current window', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                await callSKApi(anchor, 'mapcmdkey', 'g-014', 'cmd_tab_copy_urls_magic_all_window');
