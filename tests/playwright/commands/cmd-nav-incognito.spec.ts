 ...
 *
 * Run:
 *   bunx playwright test tests/playwright/commands/cmd-nav-incognito.spec.ts
 */
...
const SUITE_LABEL = 'cmd_nav_incognito';
...
test.describe('cmd_nav_incognito (Playwright)', () => {
    ...
    test.beforeEach(async () => {
        ...
        await callSKApi(page, 'mapcmdkey', 'gtg', 'cmd_nav_incognito');
    });

    test('opens an incognito window with the current page URL', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                // Verify the incognito tab was opened with the fixture URL (or is navigating to it)
