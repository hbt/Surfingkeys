...
const SUITE_LABEL = 'cmd_feed_keys';
...
test.describe('cmd_feed_keys (Playwright)', () => {
    ...
    test.beforeEach(async () => {
        ...
        await callSKApi(page, 'mapcmdkey', 'zF', 'cmd_feed_keys');
    });
    ...
    test('cmd_feed_keys executes via command bar without error', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            // Programmatically dispatches the 'j' key sequence
            ...
            await page.keyboard.type('feedkeys j');
