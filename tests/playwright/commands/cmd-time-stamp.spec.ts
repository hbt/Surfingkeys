...
const SUITE_LABEL = 'cmd_time_stamp';
...
test.describe('cmd_time_stamp (Playwright)', () => {
    ...
    test.beforeEach(async () => {
        ...
        await callSKApi(page, 'mapcmdkey', ':', 'cmd_time_stamp');
    });
    ...
    test('cmd_time_stamp executes via command bar without error', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            ...
            await page.keyboard.type('timeStamp 1609459200000');
