...
const SUITE_LABEL = 'cmd_omnibar_copy_urls';
const UNIQUE_ID = 'cmd_omnibar_copy_urls';
const KEY = '<Ctrl-c>';
...
test.describe('cmd_omnibar_copy_urls (Playwright)', () => {
    ...
    test('cmd_omnibar_copy_urls is invocable with omnibar open', async () => {
        await withPersistedDualCoverage({ suiteLabel: SUITE_LABEL, coverageUrl: FIXTURE_URL, covBg, initContentCoverageForUrl }, test.info().title, async () => {
            ...
            const ok = await invokeCommand(page, 'cmd_omnibar_copy_urls');
