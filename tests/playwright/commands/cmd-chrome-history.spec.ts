...
const SUITE_LABEL = 'cmd_chrome_history';
const FIXTURE_URL = `${FIXTURE_BASE}/scroll-test.html`;
const CONTENT_COVERAGE_URL = `${FIXTURE_URL}#cov_cmd_chrome_history`;
const EXPECTED_URL_PREFIX = 'chrome://history';

let context: BrowserContext;
let covBg: ServiceWorkerCoverage | undefined;
let initContentCoverageForUrl: ((url: string) => Promise<ServiceWorkerCoverage | undefined>) | undefined;

test.describe('cmd_chrome_history (Playwright)', () => {
    ...
    test('opens chrome://history/ tab', async () => {
        await withPersistedDualCoverage(
            ...
            async () => {
                ...
                expect(invoked, 'invokeCommand must acknowledge cmd_chrome_history').toBe(true);
