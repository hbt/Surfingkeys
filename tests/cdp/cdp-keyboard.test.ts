 ...
 *
 * Tests keyboard event delivery and command execution using Jest framework.
 *
 * Usage:
 *   Live browser:    npm run test:cdp tests/cdp/cdp-keyboard.test.ts
 *   Headless mode:   npm run test:cdp:headless tests/cdp/cdp-keyboard.test.ts
 */
