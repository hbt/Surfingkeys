 ...
 *
 * Tests DOM manipulation and hint creation using Jest framework.
 *
 * Usage:
 *   Live browser:    npm run test:cdp tests/cdp/cdp-dom.test.ts
 *   Headless mode:   npm run test:cdp:headless tests/cdp/cdp-dom.test.ts
 */
