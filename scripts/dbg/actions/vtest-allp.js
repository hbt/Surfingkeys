...
function generateTestAllSummary(testAllJson) {
    ...
    const overviewRows = [
        ...
        ['Successful Files', String(summary.successfulFiles || 0)],
        ['Failed Files', String(summary.failedFiles || 0)],
        ['Total Tests', String(summary.totalTests || 0)],
        ['Passed Tests', String(summary.totalPassed || 0)],
        ['Failed Tests', String(summary.totalFailed || 0)],
